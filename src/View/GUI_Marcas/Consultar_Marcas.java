 ...
 * @author alexis
 */
public class Consultar_Marcas extends javax.swing.JFrame {
    Marcas_DB marca_db = new Marcas_DB();

    /**
     * Creates new form Consultar_Marcas
     */
    public Consultar_Marcas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Marcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
